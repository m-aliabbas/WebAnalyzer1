...
// import { Container, Typography, Card as MuiCard, CardContent, Divider, Box, Chip, IconButton, Paper, Button, Snackbar } from '@mui/material';
...
//     axios.post('http://127.0.0.1:8000/get_parent_by_id/', { ids: id })
//       .then(response => setParentData(response.data))
//       .catch(error => console.error('Error fetching parent data:', error));

//     // Fetch sub-cards
//     axios.post('http://127.0.0.1:8000/get_child_pages', { ids: id })
